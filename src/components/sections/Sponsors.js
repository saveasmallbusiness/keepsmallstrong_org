...
const Sponsors = () => (
  <div className="container px-8 sm:px-16 mx-auto rounded-lg text-center">
    <h2 className="text-3xl lg:text-4xl font-headline uppercase font-dark font-bold mb-8 justify-center">
      <img src={inspiredCollectiveImage} className="h-auto mx-auto" alt="An inspired collective" />
    </h2>
    <p className="text-l mb-12 md:text-xl md:w-8/12 mx-auto md:mb-16">
    ...
    <p className="text-l my-12 md:text-xl md:w-8/12 mx-auto md:my-16">
