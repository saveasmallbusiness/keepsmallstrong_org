        ...
        <div className="container px-8 sm:px-16 mx-auto">
          <div className="lg:flex lg:flex-row">
            <div className="lg:w-5/12 mb-8 lg:mb-0 md:pl-4 md:pr-10">
              ...
              <h3 className="text-5xl font-headline uppercase leading-none mb-3">Small Business<br/>Needs Us More Than Ever</h3>
              <p>
                While we have an ever-growing team behind this effort, we can undoubtedly use more help.
              </p>
              <p className="py-8">
                Small business in America is not only the embodiment of The Dream, 
                they’re responsible for nearly half of our economy and two-thirds of all new job creation.
                Together, we can save thousands of small businesses from closing their doors.
